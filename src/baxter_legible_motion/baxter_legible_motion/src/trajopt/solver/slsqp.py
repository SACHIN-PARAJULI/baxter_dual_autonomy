...
class SLSQPSolver(Solver):
    ...
    def __call__(self):
        ...
        t0 = N.array(0, float)
        tol = N.array(0, float)
        iexact = N.array(0, int)
        incons = N.array(0, int)
        ireset = N.array(0, int)
        itermx = N.array(0, int)
        line = N.array(0, int)
        n1 = N.array(0, int)
        n2 = N.array(0, int)
        n3 = N.array(0, int)
        ...
        while 1:
            ...
            # https://github.com/scipy/scipy/blob/main/scipy/optimize/_slsqp_py.py
