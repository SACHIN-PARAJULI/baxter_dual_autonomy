...
def main():
    ...
    obstaclePosition_2 = np.asarray([0.65, 0.0, 0.78])
    obstaclePosition_3 = np.asarray([0.75, 0.2, 0.78])
    obstaclePosition_4 = np.asarray([0.8, 0.15, 0.78])
    ...
    while np.linalg.norm( xyz_updated - xyz_prev) > epsilon or all(xyz_updated == 0):
