...
def main():
    ...
    # pose_updated[0] = current_pose.position.x
    # pose_updated[1] = current_pose.position.y
    # pose_updated[2] = current_pose.position.z
    # pose_updated[3] = current_pose.orientation.x
    # pose_updated[4] = current_pose.orientation.y
    # pose_updated[5] = current_pose.orientation.z
    # pose_updated[6] = current_pose.orientation.w
    # xyz_updated[0] = current_pose.position.x
    # xyz_updated[1] = current_pose.position.y
    # xyz_updated[2] = current_pose.position.z
    # midpoints_added = []
    ...
    while True:
        ...
        #
        #     # set index to midpoints_added_index
        #     # if index == midpoints_added[index]:
        #     # print('index')
        #     # print(index)
        #
        ...
        #         xyz_prev[index*3:index*3+3] = pose_index[0:3]
        #
        ...
        #     # print(' ')
        #
        #     if stop_rule_counter == 0 or (index in midpoints_added):
        #         # print('update pose with force')
        #         # print(index)
        #
        ...
        #         # dir_1 = dir_1 - dir_target
        #         # obstacle 2
        #         dir_2 = z_array*((eePosition - obstaclePosition_2) / np.linalg.norm((eePosition - obstaclePosition_2)))
        #         # with respect to ee and target direction
        #         # dir_2 = dir_2 - dir_target
        #         U_potential_gradient_rep_2_sphere = U_potential_gradient_rep_2 * dir_2
        #         # obstacle 3
        #         dir_3 = z_array*((eePosition - obstaclePosition_3) / np.linalg.norm((eePosition - obstaclePosition_3)))
        #         # with respect to ee and target direction
        #         # dir_3 = dir_3 - dir_target
        #         U_potential_gradient_rep_3_sphere = U_potential_gradient_rep_3 * dir_3
        #         # obstacle 4
        #         dir_4 = z_array*((eePosition - obstaclePosition_4) / np.linalg.norm((eePosition - obstaclePosition_4)))
        #         # with respect to ee and target direction
        #         # dir_4 = dir_4 - dir_target
        ...
        #
        #     else:
        #         xyz_updated[index*3:index*3+3] = xyz_prev[index*3:index*3+3]
        #         pose_updated[index*7:index*7+3] = xyz_prev[index*3:index*3+3]
        #
        #     index = index + 1
        #
        # # print('plan2')
        ...
        # # # print(waypoints)
        # #
        # # # calculate midpoints if stop rule > epsilon:
        # # length_plan2 = len(plan2.joint_trajectory.points)
        # index_modified = 1
        # index = 1
        #
        ...
        #
        # #
        # # # cut xyz_updated and xyz_prev to same length
        ...
        # midpoints_added = []
        # midpoints_array = []
        # # print('len(xyz_updated)/3')
        # # print(len(xyz_updated)/3)
        # # print(len(xyz_prev)/3)
        # # print(type(plan2.joint_trajectory.points))
        # while index < len(xyz_updated)/3-1:
        #
        #     # xyz_updated[index*3:index*3+3] = eePosition_moveit_plan_next_updated
        #     point_updated = xyz_updated[index*3:index*3+3]
        #     point_prev = xyz_prev[index*3:index*3+3]
        #
        #     print(' ')
        #     print('stop rule')
        #     print(index)
        #     print(np.linalg.norm( point_updated - point_prev ))
        #     if np.linalg.norm( point_updated - point_prev ) > epsilon:
        #
        ...
        #         # print(index)
        #
        #         midpoint = (point_updated + point_prev)/2
        ...
        #
        #         print('joints_midpoint')
        #         print(joints_midpoint)
        #
        #         # # try again
        #         # index_joints_midpoint = index
        #         # while joints_midpoint is None:
        #         #     index_joints_midpoint = index_joints_midpoint + 1
        #         #     joints_current = plan2.joint_trajectory.points[index_joints_midpoint].positions
        #         #     pose_current = kdl_kin.forward(joints_current)
        #         #     pose_midpoint = pose_current
        #         #     pose_midpoint[0,3] = midpoint[0]
        #         #     pose_midpoint[1,3] = midpoint[1]
        #         #     pose_midpoint[2,3] = midpoint[2]
        #         #     joints_midpoint = kdl_kin.inverse(pose_midpoint)
        #         #     print('joints_midpoint next try')
        #         #     print(joints_midpoint)
        #
        #         # q_points_list = np.array(plan2.joint_trajectory.points)
        #         q_points_list = plan2.joint_trajectory.points
        ...
        #         q_points_list_index = q_points_list[index]
        #         q_positions_list = list(plan2.joint_trajectory.points[index].positions)
        #         for i in range( len(q_positions_list) ):
        #             print('i')
        #             print(i)
        #             print(joints_midpoint[i].item())
        #             q_positions_list[i] = joints_midpoint[i].item()
        #         q_points_list_index.positions = q_positions_list
        #         # q_points_list = np.insert(q_points_list, index_modified, q_points_list_index)
        #         q_points_list.insert(index_modified, q_points_list_index)
        #         # q_points_list.insert(index, q_points_list_index)
        #         # plan2.joint_trajectory.points = tuple(q_points_list)
        #         plan2.joint_trajectory.points = q_points_list
        #
        #         # xyz_prev = np.insert(xyz_prev, index_modified, midpoint)
        #         # print(xyz_prev)
        #         midpoints_array.append(midpoint)
        #
        #         # add midpoint
        #         midpoints_added.append(index)
        #         print('add a midpoint')
        #         index_modified = index_modified + 1
        #
        #     index_modified = index_modified + 1
        #     index = index + 1
        #
        # print('midpoints_added')
        # print(midpoints_added)
        # print(midpoints_array)
        #
        # # print('length xyz before')
        # # print(len(xyz_updated))
        # # print(len(xyz_prev))
        #
        # # for i in range(len(midpoints_added)):
        # #     print('i for xyz ')
        # #     print(i)
        # #     print(midpoints_added[i]*3)
        # #     print(midpoints_array[i])
        # #     xyz_updated = np.insert(xyz_updated, midpoints_added[i]*3, midpoints_array[i])
        # #     xyz_prev = np.insert(xyz_prev, midpoints_added[i]*3, midpoints_array[i])
        #
        #
        # print('length xyz after')
        # print(len(xyz_updated))
        # print(len(xyz_prev))
        # print(xyz_updated)
        # print(xyz_prev)
